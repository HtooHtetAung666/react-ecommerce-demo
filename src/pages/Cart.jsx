...
export const Cart = () => {
  ...
  return (
    <div className="w-full min-h-screen p-8 lg:p-20 lg:max-w-7xl lg:mx-auto">
      <h1 className="text-center text-3xl font-bold text-slate-800 mt-6">
        Cart Items
      </h1>
      {totalAmount > 0 ? (
        <div>
          ...
          <div className="mt-5 flex items-center justify-center text-slate-800">
            <div className="space-x-4">
              ...
              <button className="bg-blue-400 p-2 rounded-xl text-white hover:bg-indigo-300">
                Checkout
              </button>
            </div>
          </div>
        ...
        <h1 className="mt-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-red-600 text-lg">
          Your Cart is empty
        </h1>
      )}
    </div>
